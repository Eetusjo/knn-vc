...
**New:** kNN-VC now supports **continuous morphing** - creating speech that gradually transitions from one speaker to another over the duration of an utterance. This is particularly useful for perceptual experiments and creative applications.
...
For detailed usage, see [README_MORPHING.md](README_MORPHING.md) and the examples in `examples/`.
